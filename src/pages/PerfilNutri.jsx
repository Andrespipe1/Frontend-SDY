            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
              ...
              <form onSubmit={handleActualizarPerfil} className="space-y-6">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="cursor-pointer w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
              ...
              <form onSubmit={handleActualizarPassword} className="space-y-6">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors cursor-pointer"
