...
const Perfil = () => {
  ...
  useEffect(() => {
    const obtenerPerfil = async () => {
      try {
        ...
        setMensaje({ respuesta: 'Error al obtener el perfil', tipo: false });
      }
    };
  ...
  const handleActualizarPerfil = async (e) => {
    ...
    try {
      ...
      setMensaje({ respuesta: data.msg || 'Perfil actualizado correctamente', tipo: true });
    } catch (error) {
      setMensaje({ respuesta: error.response?.data?.msg || 'Error al actualizar perfil', tipo: false });
    }
  };
  ...
  return (
<div className="flex flex-col lg:flex-row gap-10 justify-center items-start px-6 py-12">
      {/* Mensaje de alerta */}
