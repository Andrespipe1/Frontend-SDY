    ...
    <div className="h-screen w-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white shadow-lg rounded-lg w-[1000px] md:w-[600px] md:h-[400px] p-8 md:p-10 flex flex-col justify-center">
        ...
        <form>
          <div className="mb-4">
            ...
            <input
              ...
              className="block w-full rounded-md border border-gray-300 focus:border-indigo-600 focus:outline-none focus:ring-1 focus:ring-indigo-600 py-2 px-3 text-gray-700"
              name="email"
            />
          </div>

          <button className="bg-indigo-600 text-white py-3 w-full rounded-lg mt-4 hover:bg-indigo-500">
            Enviar email
          </button>
        </form>
        ...
        <div className="mt-5 text-sm flex justify-between items-center">
          ...
          <Link
            to="/login"
            className="py-2 px-6 bg-indigo-600 text-white rounded-lg hover:bg-indigo-500"
          >
            Login
          </Link>
        </div>
